...
import { l as require_react_dom, y as require_jsx_runtime, z as require_react } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as TSS_SERVER_FUNCTION, r as getServerFnById, t as createServerFn } from "./ssr.mjs";
import { S as ArrowUp, _ as Globe, a as Settings, b as ChevronDown, c as Play, d as Palette, f as Lock, g as History, h as Image, i as SkipForward, l as Pin, m as LayoutGrid, o as Search, p as Library, r as Telescope, s as Plus, t as X, u as Pause, v as Folder, x as Check, y as FileText } from "../_libs/lucide-react.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DY2S06As.js
...
function seedConversations() {
	...
	const now = Date.now();
	for (const [id, line] of Object.entries({
		"free/minimax-m3": {
		...
		role: "user",
		text: line.user,
		createdAt: now - line.ago
	}, {
		id: `seed-a-${id}`,
		role: "assistant",
		text: line.assistant,
		createdAt: now - line.ago + 2e4
	}];
	return seed;
}
function seedFiles() {
...
var useAether = create()(persist((set, get) => ({
	...
	setPromptOpen: (v) => set(v ? { promptOpen: true } : {
		promptOpen: false,
		promptPos: {
			x: 0,
			y: 0
	...
	addGenieMessage: (msg) => set((s) => ({ genieMessages: [...s.genieMessages, msg] })),
...
function Environment() {
	...
	const veil = surface === "card" ? "untint" : surface === "discover" || surface === "themes" || surface === "upgrade" || surface === "smart" || surface === "files" || historyOpen ? "work" : "home";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `env-veil veil-${veil}` }),
...
function isInteractive(t) {
	return Boolean(t.closest("button") || t.closest("input") || t.closest("textarea") || t.closest("select") || t.closest("a") || t.closest("label") || t.closest("[contenteditable='true']"));
}
/**
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						type: "button",
						className: "text-btn",
						onClick: () => useAether.getState().setHistoryOpen(true),
						children: "History"
					})]
				})]
			}),
...
function PreviewStage({ title, kicker, src, video, onClose, actions, related = [], onRelated, children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			type: "button",
			className: "close-affordance in-stage",
			"aria-label": "Close",
			onClick: onClose
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "f1-hero",
...
function FilesView() {
	...
	const scopedId = useAether((s) => s.surface) === "files" ? cardModelId : null;
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: buckets.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						...
						children: list.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
...
function groupByModel(files) {
	const map = /* @__PURE__ */ new Map();
	for (const f of files) {
		const label = MODELS.find((m) => m.id === f.modelId)?.name ?? (f.modelId === "imagine" ? "Imagine" : "Files");
...
function HistoryView() {
	...
	const q = query.trim().toLowerCase();
	const rows = Object.values(conversations).map((c) => {
	...
	}).filter((r) => r.turns > 0).filter((r) => scoped ? r.modelId === scoped : true).filter((r) => {
		if (!q) return true;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
		...
		className: "empty-line",
		children: q ? "Nothing matches that." : "No conversations yet."
	}) : rows.map((r) => {
		const model = MODELS.find((m) => m.id === r.modelId);
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				className: "hist-meta",
				children: [model ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "hist-tag",
					style: {
						color: model.accent,
						borderColor: `${model.accent}77`
					},
...
function ThemeView() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "surface-label",
				children: tab === 0 ? "Wallpapers" : "Live wallpapers"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "chip-row",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "dots",
				"aria-hidden": true,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: tab === 0 ? "on" : "" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: tab === 1 ? "on" : "" })]
			}),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: items.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						"video" in d && d.video ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
							src: d.video,
							poster: d.src,
							muted: true,
							loop: true,
			...
			selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PreviewStage, {
				...
				actions: [
					...
					},
					{
						...
						onClick: () => {
							if (!mine.some((m) => m.id === selected.id)) setMine((m) => [{
								id: uid("im"),
								src: selected.src,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					page === "hub" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HubPage, {}) : null,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: "Smart Boards"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				className: "hub-btn",
				onClick: () => setPage("canvas"),
				children: "Smart Canvas"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				className: "hub-btn",
				onClick: () => setPage("genie"),
				children: ["Smart Genie", tier === "free" ? " · Pro" : ""]
			})
		]
	});
}
function CardsPage({ cards, onOpen }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mem-scroll",
			children: groups.map(([k, list]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "years-block",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "years-label",
					children: labelKind(k)
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mem-grid",
					children: list.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [c.preview ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							...
							className: "mem-cap",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: c.title }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: labelKind(c.kind) })]
						})]
					}, c.id))
				})]
			}, k))
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
				...
				children: SMART_KINDS.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
					value: k.id,
					children: k.label
				}, k.id))
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 14 }), "Pop out"]
			})]
		})]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: SMART_LANES.map((lane) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: `obj-chrome obj-${lane.object}`,
						"aria-hidden": true
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
...
function GeniePage() {
	...
	const [busy, setBusy] = (0, import_react.useState)(false);
	if (tier === "free") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "genie-wrap",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "genie-kicker",
				children: "Smart Genie"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "genie-hint",
				children: "The agent that makes cards, boards, and canvases. Pro and above."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				className: "genie-pop",
	...
	async function send() {
		...
		const res = await askModel({ data: {
			modelId: "genie",
			persona: "Smart Genie, an agent inside Aether. You make and reorganize Smart Cards, Boards, and Canvas objects. Speak plainly. When you create something, say its title and type in one short line starting with MADE:",
			messages: useAether.getState().genieMessages.slice(-8).map((m) => ({
				role: m.role,
				content: m.text
			}))
		} });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "genie-hint",
				children: "Ask for a card, a board, or a rearrangement. It stays in this canvas."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "genie-thread quiet-scroll",
				children: messages.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "empty-line",
					children: "What should we make."
...
function ModelsTab() {
	...
	const [menuBox, setMenuBox] = (0, import_react.useState)(null);
	const catBtnRef = (0, import_react.useRef)(null);
	...
	(0, import_react.useEffect)(() => {
		...
		const onDoc = (e) => {
			...
			if (e.target.closest?.(".cat-overlay")) return;
			setOpenCat(false);
		};
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: catLabel }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { size: 14 })]
				})
			}),
			openCat && menuBox ? (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								"aria-hidden": true,
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "light-bloom" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "light-ring" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "light-core" })
								]
							})
						]
					}, m.id);
...
function PromptBar() {
	...
	const [attaches, setAttaches] = (0, import_react.useState)([]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "composer",
		children: [
			attaches.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "attach-row",
				children: attaches.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", { children: a.name }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							"aria-label": "Remove attachment",
							onClick: () => setAttaches((xs) => xs.filter((x) => x.id !== a.id)),
							children: "×"
						})
					]
				}, a.id))
			}) : null,
			tray ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "investigate-tray",
				children: INVESTIGATION.map((opt) => {
					const Icon = opt.Icon;
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				onSubmit: (e) => {
					e.preventDefault();
					sendPrompt(attaches, () => setAttaches([]));
				},
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 18 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: "send-btn",
						"aria-label": "Send",
						disabled: sending || !text.trim() && !attaches.length,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"aria-hidden": true,
							children: "↑"
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						onClick: () => setTray((v) => !v),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Telescope, { size: 16 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "ctrl-label",
							children: active ? active.label : "Search"
						})]
					})
				]
			})
...
async function sendPrompt(attaches, clearAttaches) {
	const s = useAether.getState();
	const text = s.promptText.trim();
	if (!text && !attaches.length || s.sending) return;
	const payload = (s.investigation === "web" ? "Web search. " : s.investigation === "research" ? "Research report. " : s.investigation === "deep" ? "Deep research with sources. " : "") + (text || "Look at the attached still.");
	s.setSending(true);
	s.flashSend();
	s.setPromptText("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Consensus" })
...
function SpatialShell() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: `app-root${promptOpen ? " prompting" : ""}${inCard ? " untint" : working || historyOpen ? " work-tint" : " home-tint"}`,
		children: [
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							inCard || working ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className: "close-affordance",
								"aria-label": "Close",
								onClick: inCard ? close : backFromWork
							}) : null,
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
								...
								children: [working ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "work-frost",
									"aria-hidden": true
			...
			working ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PromptCluster, {}),
			working ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsensusMap, {})
		]
	});
}
function PromptCluster() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: `prompt-seat${open ? " open" : ""}`,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Draggable, {
			x: pos.x,
			y: pos.y,
			onMove: setPos,
			armMs: 240,
			className: "prompt-drag",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsensusPreview, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PromptBar, {})]
		})
	});
}
function Home() {
